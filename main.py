...
with st.sidebar:
    ...
    youtube_url = "https://www.youtube.com/channel/UCNGo4QsCi5mTSdYaabIOhgQ"
    linkedin_url = "https://www.linkedin.com/in/pritee-shah-089100202/"
    github_url = "https://github.com/Priti12345-sys"
    wordpress_url = "https://github.com/Priti12345-sys"
    email_url = "shahpritee635@gmail.com"
    with st.container():
...
if choose == "About Me":
    ...
    with st.container():
        ...
        with left_column:
            st.header("About Me")
            st.subheader("👨🏼‍💻 Career aspiration: Aspiring Developer")
            st.write("👋🏻 Hello, I'm Pritee Shah! I'm a Laravel developer undergraduate based in Malaysia. Having prior relevant experiences in tech, reinsurance and consulting sectors, I am constantly seeking unique internships to broaden my horizons before embarking on my data career upon graduation.")
            st.write("💼 With the COVID-19 pandemic behind us, I believe there is potential for data science to be applied in the software development industry. In response to the increasing demand for data analytics from both online and offline projects, I am thus aiming to enter this industry for my first full-time job as a Laravel developer.")
            st.write("🏋🏻 In addition, I like to exercise in the gym, run, write, play video games and enjoy eating good food in my free time!")
            st.write("👨🏼‍💻 Academic interests: Data Visualization, Market Basket Analysis, Recommendation Systems, Natural Language Processing, Laravel, HTML, CSS, Data Analysis, PHP, Database, and so on.")
    ...
    with st.container():
            ...
            with col1:
                st.empty()
            with col2:
                st.video("https://youtu.be/Rg51YnpRPRs?si=eMq4ynuqGppPTgHk")
            with col3:
                st.empty()
    st.markdown(r"""
...
# Create section for Work Experience
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Data Science Intern, [Nepa Wholesale](https://nepa2wholesale.com/)")
    ...
    with st.container():
        ...
        with text_column:
            st.subheader("Data Analysis Intern, [Mantraideas](https://mantraideas.com/)")
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_scor)
        with text_column:
            st.subheader("Developer Intern, [i3websolution](https://www.i3websolution.com/)")
    ...
    with st.container():
        ...
        with image_column:
            st.image(img_yll)
        with text_column:
            st.subheader("Temporary Management Support Staff, [Allstar-it-solution-pvt--ltd](https://www.kumarijob.com/allstar-it-solution-pvt--ltd)")
...
#st.write("---")
    ...
    if selected == "Summary":
        ...
        with st.container():
            ...
            with image_column:
                st.image(img_nus)
            with text_column:
                st.subheader("Bachelor of Information Technology -  [National University of Nilai](https://www.padmashreecollege.edu.np/scholarship/form) (2020-2024)")
                ...
                st.markdown(r"""
                - [NUN Product Club](https://linkedin.com/company/nusproductclub) - Co-founder & President (2023-24)
                - [NUN Statistics and Data Science Society](https://sites.google.com/view/nussds/home) - President (2022), Marketing Director (2021-22)
        ...
        with st.container():
            ...
            with image_column:
                st.image(img_poc)
            with text_column:
                st.subheader("Intermediate - Management Business, [National University of Nepal](https://liverpool.edu.np/) (2016)")
                st.write("Coursework: Foundations of Business, Accountancy, Mathamatic,")
                st.markdown(r"""
                ...
                - [NUN Students' Science Club](https://www.nussciencelife.com/) - Marketing Executive, Welfare Subcommittee
                - Pharmaceutical Science (Class of 2023) - Assistant Class Representative
                """)
    elif selected == "Modules":
        st.subheader("Modules")
        st.write("*List of modules taken at National University of Nilai*")
        with st.container():
    ...
    if selected == "Overview":
        ...
        *Pritee Shah is the Marketing Director of the NUS Statistics and Data Science Society (AY21/22)*       
        """)
    ...
    resume_url = "https://drive.google.com/file/d/1Dvg7S-TCg4y3TAKdoRTdteQlQp4TvWzc/view?usp=drive_link"
    st.header("Resume")
    ...
    show_pdf("Priteeshah.pdf")
    with open("Priteeshah.pdf", "rb") as file:
        btn = st.download_button(
            label="Download Resume (1 page)",
            data=file,
            file_name="Priteeshah.pdf",
            mime="application/pdf"
        )
elif choose == "Testimonials":
    test_url = "https://drive.google.com/file/d/1Dvg7S-TCg4y3TAKdoRTdteQlQp4TvWzc/view?usp=drive_link"
